...
export default function Find() {
  return (
    <div className="w-full h-[50vh] mt-12 flex-col flex items-center justify-between p-10 gap-8" style={{backgroundImage: 'url(/maps.avif)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
<div className='flex flex-col gap-8 items-center justify-center'>

<h1 className='font-semibold text-5xl font-banger tracking-wider text-center text-red-700'>Find us on  <br />
     <span className="font-sans text-green-700 font-bold tracking-tighter">Google Maps</span>
</h1>
