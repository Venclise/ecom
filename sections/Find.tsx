...
export default function Find() {
  return (
    <div className="w-full h-[50vh] mt-12 flex-col flex items-center justify-center p-10 gap-8" style={{backgroundImage: 'url(/maps.avif)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
